...
For further project details, predefined features, evaluation results and the used literature see the [final report](https://github.com/MaviccPRP/ml_ner/blob/master/reports/final_report.pdf) in the reports/ folder.
